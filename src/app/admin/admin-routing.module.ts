...
import { AdminOnlyGuard, SuperAdminAuditorGuard, SuperAdminGuard, EnforcePasswordChangeAdminGuard } from '../shared';
...
const routes: Routes = [{
  ...
  children: [
    ...
    { path: 'claims', canActivate: [EnforcePasswordChangeAdminGuard], component: AdminClaimsComponent },
